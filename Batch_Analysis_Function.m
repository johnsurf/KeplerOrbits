...
[SVestimated1, CovSV1, fit, CovFit, ChiSq] = BuildPolyKeplerMatrix(SVBest, TExtrap, TPolyFit, track_data, Iorder, iType, units, InvCovUV);
ChiSq
...
[Iorder, fit, CovFit] = PolyCorrFit(Object, track_data, TPolyFit, Iorder, iType, units, InvCovUV);
...
StateVectorECI = [state_vector; TExtrap];
[SVestimated2, CovSV1, fit, CovFit, ChiSq] = BuildPolyKeplerMatrix(StateVectorECI, TExtrap, TPolyFit, track_data, Iorder, iType, units, InvCovUV);
...
StateVectorECI = SVestimated2
[KeplerFit1, CovFit1, TFit, SV7Fit1] = LeastSquaresAllSatellites(track_data, TFit, 1, 0, StateVectorECI, InvCovUV, units, InitialState)
